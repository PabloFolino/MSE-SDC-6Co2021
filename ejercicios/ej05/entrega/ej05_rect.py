...
fig_h = plt.figure()
h_axe = fig_h.add_subplot(1,1,1)
h_axe.set_title("Canal - Filtro pasabajos")
h_axe.stem(h3)
h_axe.set_xlabel("k")
h_axe.set_ylabel("h3[k]")

fig_p = plt.figure()
p_axe = fig_p.add_subplot(1,1,1)
p_axe.set_title("Pulso rectangular")
p_axe.stem(p_mod)
p_axe.set_xlabel("k")
...
real_axe_1.set_title("Pulso rectangular - Canal 1: Delta fase cero - Sigma_N: %f" % SIGMA_N)
...
real_axe_2.set_title("Pulso rectangular - Canal 2: Delta fase distina de cero - Sigma_N: %f" % SIGMA_N)
...
real_axe_3.set_title("Pulso rectangular - Canal 3: Pasabajos - Sigma_N: %f" % SIGMA_N)
