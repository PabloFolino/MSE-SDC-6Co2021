...
HD_PWD='/home/pablo/Documentos/02_Maestria_en_Sistemas_Embebidos/21_Sistemas_Digitales_para_las_Comunicaciones/workspace2/micro/micro.runs/system_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
