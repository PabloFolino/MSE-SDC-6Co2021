...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set arst_o [ create_bd_port -dir O -from 0 -to 0 arst_o ]
  set locked_microblaze [ create_bd_port -dir I locked_microblaze ]
  set mn1_bytes_microblaze [ create_bd_port -dir O -from 7 -to 0 mn1_bytes_microblaze ]
  set mn1_pre_microblaze [ create_bd_port -dir O -from 7 -to 0 mn1_pre_microblaze ]
  set reset [ create_bd_port -dir I -type rst reset ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] $reset
  set selector_sw [ create_bd_port -dir O -from 0 -to 0 -type data selector_sw ]
  set sigma_microblaze [ create_bd_port -dir O -from 15 -to 0 sigma_microblaze ]
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_ports arst_o] [get_bd_pins axi_gpio_2/gpio2_io_o]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_ports selector_sw] [get_bd_pins axi_gpio_2/gpio_io_o]
  connect_bd_net -net axi_gpio_3_gpio2_io_o [get_bd_ports mn1_bytes_microblaze] [get_bd_pins axi_gpio_3/gpio2_io_o]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_ports mn1_pre_microblaze] [get_bd_pins axi_gpio_3/gpio_io_o]
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_ports sigma_microblaze] [get_bd_pins axi_gpio_4/gpio_io_o]
  connect_bd_net -net axi_uartlite_0_tx [get_bd_ports usb_uart_txd] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net locked_microblaze_1 [get_bd_ports locked_microblaze] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_ports sys_clock] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
