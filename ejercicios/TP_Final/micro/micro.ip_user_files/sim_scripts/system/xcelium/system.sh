...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../micro.gen/sources_1/bd/system/ipshared/6dcf" \
       +incdir+"$ref_dir/../../../../micro.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../micro.gen/sources_1/bd/system/ipshared/6dcf" \
       +incdir+"../../../../micro.gen/sources_1/bd/system/ipshared/ec67/hdl"
}
